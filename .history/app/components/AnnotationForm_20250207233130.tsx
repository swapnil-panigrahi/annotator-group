...
const aspects: AspectRating[] = [
  {
    ...
    description: "How well does the summary cover all the main points of the original text?",
  },
  {
    name: "LaymanFriendliness",
    stateKey: "laymanFriendliness",
    label: "Layman-friendliness",
